...
export const GroupLessonFormSchema = yup.object().shape({
  ...
  recruitment_period_date_start: yup.string().required('recruitment period date start is required '),
  recruitment_period_date_end: yup.string().required('recruitment period date end is required '),
