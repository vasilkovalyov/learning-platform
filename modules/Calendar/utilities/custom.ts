...
export function getEventsArrayForDay(date: Date, events: CalendarEventType[] = []): IEventsArrayForDay[] | null {
...
export function getFilteredEventByDate(date: Date, events: CalendarEventType[]): CalendarEventType[] | [] {
